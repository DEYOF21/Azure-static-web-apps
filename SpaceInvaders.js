(function(){
  ...
  function drawBottomHud() {
    ...
    fillCenteredText('POENGSUM: ' + player.score, CANVAS_WIDTH/2, 20);
  ...
  function drawStartScreen() {
    ...
    fillBlinkingText("Trykk på Space knappen for å spille!", CANVAS_WIDTH/2, CANVAS_HEIGHT/2, 500, '#FFFFFF', 36);
  }
  ...
  function animate() {
    ...
    var dt = now - lastTime;
    if (dt > 100) dt = 100;
    if (wasKeyPressed(32) && !hasGameStarted) {
      initGame();
      hasGameStarted = true;
    }
